#'@title creates a dataframe containing the points for the Fermat espiral mandala
#'@name pespiral1
#'@author Luciane Ferreira Alcoforado
#
#'
#'@description  Function to build a espiral de Fermat
...
pespiral1 = function(theta, raio, k, n){
theta = seq(theta[1],theta[2],length.out=n)
x = raio*sqrt(theta)*cos(theta)
y = raio*sqrt(theta)*sin(theta)
